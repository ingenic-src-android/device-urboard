...
TARGET_USERIMAGES_USE_NAND := true
# system size is 640M
...
BOARD_BLUETOOTH_BDROID_BUILDCFG_INCLUDE_DIR := device/ingenic/urboard/bluetooth
...
TARGET_RECOVERY_UI_LIB := librecovery_ui_urboard
